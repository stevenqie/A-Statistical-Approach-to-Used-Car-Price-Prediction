...
This car's original MSRP was approxmiately 40,395. Our model predicted the car to be around 4k higher than the actual price. The discrpeneices could be due to various different features. 
...
pred_toyota_new <- predict(lassomodel, newx = as.matrix(ford_new), s = "lambda.min")
pred_toyota_new
```
The actual price of a new Ford Maverick XLT at the time is 29,541.47
...
The actual price of a porsche 718 spyder base 2022 model is approximiately 98,300 dollars. 
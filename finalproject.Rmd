...
colnames(data)[colnames(data) == "transmission"] <- "transmission_"
```
...
data$transmission_ <- sapply(data$transmission_, map_transmission)

# One-hot encoding
transmission_dummies <- model.matrix(~ transmission_ - 1, data = data)
...
data$transmission_factored <- factor(data$transmission_)
```
